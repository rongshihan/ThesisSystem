...
public class Preview_ThesisServlet extends BaseControllerSupport 
{

	private B01ImplServices b01ImplServices=new B01ImplServices();
	
	public Preview_ThesisServlet()
	{
	...
	{
		List<Map<String,String>> dataList=b01ImplServices.previewQuery();
		if(dataList.size()>0) 
		{
